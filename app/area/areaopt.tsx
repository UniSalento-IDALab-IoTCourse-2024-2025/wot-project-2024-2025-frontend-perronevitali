...
export default function AreaOptionScreen(){
    ...
    const goToTask = async () =>{
        router.replace("/activity/activities")
    }
    const goToEdit = async () =>{
            router.replace("/area/areaedit")
    }
    ...
    return(
      <View style={styles.container}>
        ...
        <List.Section>
              ...
              <List.Item
                title="Aggiorna soglie"
                style={styles.buttonCenter}
                titleStyle={styles.modalText}
                right={() => <List.Icon icon="chevron-right" />}
                onPress={() => {goToThreshold()}}
              />

              <List.Item
                title="Vedi task attive"
                style={styles.buttonCenter}
                titleStyle={styles.modalText}
                right={() => <List.Icon icon="chevron-right" />}
                onPress={() => goToTask()}
